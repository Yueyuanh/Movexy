...
//        Serial.print("check: "); Serial.println(receivedData.checksum,HEX);
//        Serial.print("check_sum: "); Serial.println(check_sum,HEX);


//        Serial.print("\033[2J");  // 发送 ANSI 清屏命令
//        Serial.print("\033[H");   // 将光标移动到左上角
  }
  }
